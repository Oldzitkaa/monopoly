...
// W tym miejscu tylko dołączamy plik, samo połączenie będzie używane przez skrypty API
// Nie ma bezpośredniego użycia połączenia w tym pliku widoku
include_once './database_connect.php'; // Upewnij się, że ścieżka jest poprawna
?>
<!DOCTYPE html>
<html lang="pl">
<head>
    ...
    <link rel="stylesheet" href="../sass/styl.css"> 
